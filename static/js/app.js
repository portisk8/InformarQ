...
function btn3Click(){
	...
	$("#cardHtml").html('<h4>Bienal 2014</h4><p>Diez artistas consagrados, representando a sus paises originarios, compitieron realizando una obra original e inedita inspirandose en "Homus Novus". Este concepto se refiere a una humanidad renovada, que haga de la alegria y de la buena voluntad sus señas de identidad, que enfrente con optimismo y confianza su futuro. El material a trabajar fue acero inoxidable, utilizado por primera vez en la competencia. Los escultores que participaron fueron: <p><div class="row"><div class="col s6"><li>Robert Kogel(Alemania)</li><li>Raul Oscar Gomez (Argentina)</li><li>Jose Baier (Austria)</li><li>Thierry Ferreira (Francia)</li><li>Kei Nakamura(Japon)</li><li>Piotr Twardowski (Polonia)</li></div><div class="col s6"><li>Hugo Maciel (Portugal)</li><li>Rubio Harak (Puerto Rico)</li><li>Gleb Tkachenko (Rusia)</li><li>Ilker Yardimici (Turquia)</li><li>Raul Zorrilla Soto-Percy (Peru)</li></div></div><p><center><video class="responsive-video" controls><source src="../static/video/Bienal2014.mp4" type="video/mp4"></video></center>');
